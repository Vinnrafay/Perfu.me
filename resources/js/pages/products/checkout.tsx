...
function ProductCard({ nama, Varian, Harga, qty, quantity, Foto }: CheckoutItem) {
    ...
    return (
        <div className="flex gap-4 w-full py-3 items-center">
            ...
            <div className="flex flex-col flex-1 justify-center min-w-0">
                ...
                <span className="text-xs text-muted-foreground mt-0.5">
                    {totalQty} Pcs x {formatRupiah(Harga)}
                </span>
            </div>
                            ...
                            <CardHeader className="border-b border-border/50 pb-4 bg-muted/20">
                                ...
                                <CardContent className="px-6 pb-6">
                                    {items.length === 0 ? (
                                        ...
                                        <div className="divide-y divide-border/60 rounded-2xl border border-border/70 bg-muted/10 overflow-hidden px-4">
                                    ...
                                    <div className="space-y-2.5 text-sm">
                                        <div className="flex justify-between text-muted-foreground">
                                            ...
                                            <span className="font-medium text-foreground">{totalQuantity} Pcs</span>
                                        </div>
                                        <div className="flex justify-between text-muted-foreground">
                                ...
                                <CardFooter className="flex flex-col p-6 bg-background border-t border-border gap-6">
                                    <div className="flex justify-between items-center w-full">
                                        <h4 className="text-sm font-semibold text-muted-foreground">Total Pembayaran</h4>
                                    ...
                                    <div className="w-full space-y-4">
                                        <Button 
                                            type="submit" 
                                            className="w-full h-12 text-sm font-medium rounded-xl bg-[#111111] hover:bg-black text-white shadow-md transition-all"
                                        ...
                                        <p className="text-[11px] text-center text-muted-foreground leading-relaxed px-2">
                                            Dengan melanjutkan, pesanan Anda akan dikirimkan ke Admin melalui WhatsApp untuk proses konfirmasi.
                                        </p>
                                    </div>
                                </CardFooter>
                            </Card>
